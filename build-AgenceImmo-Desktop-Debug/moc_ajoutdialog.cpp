...
const QMetaObject ajoutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ajoutDialog.data,
      qt_meta_data_ajoutDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
